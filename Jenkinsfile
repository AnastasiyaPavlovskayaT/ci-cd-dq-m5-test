    ...
    stage('Test suite 2. PyTest') {
     ...
     stage('Create new branch') {
      steps {
        ...
        sh 'git push https://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@github.com/AnastasiyaPavlovskayaT/ci-cd-dq-m5-test.git'
      }
    }
  }
}
